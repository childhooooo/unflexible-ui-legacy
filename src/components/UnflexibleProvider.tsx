...
:root {
  ...
  --columns-gap-wide: 3rem;
  --columns-gap-normal: 1.5rem;
  --columns-gapless: 0rem;

  --columns-gap-rate-xl: 1;
  --columns-gap-rate-l: 1;
  --columns-gap-rate-m: 1;
  --columns-gap-rate-s: 1;
  --columns-gap-rate-xs: 1;
