...
const Component = styled.div<ComponentProps>`
  ...
  column-gap: ${props => `calc(${props.config.gap[props.columnGap]} * ${props.config.gapRate.xl})`};
  ...
  @media only screen and (max-width: ${screen.l}px) {
    ...
    column-gap: ${props => `calc(${props.config.gap[props.columnGap]} * ${props.config.gapRate.l})`};
    grid-template: none / ${props => props.gridL};
  }

  @media only screen and (max-width: ${screen.m}px) {
    row-gap: ${props => `calc(${props.config.gap[props.rowGap]} * ${props.config.gapRate.m})`};
    column-gap: ${props => `calc(${props.config.gap[props.columnGap]} * ${props.config.gapRate.m})`};
    grid-template: none / ${props => props.gridM};
  }

  @media only screen and (max-width: ${screen.s}px) {
    row-gap: ${props => `calc(${props.config.gap[props.rowGap]} * ${props.config.gapRate.s})`};
    column-gap: ${props => `calc(${props.config.gap[props.columnGap]} * ${props.config.gapRate.s})`};
  ...
  @media only screen and (max-width: ${screen.xs}px) {
    ...
    column-gap: ${props => `calc(${props.config.gap[props.columnGap]} * ${props.config.gapRate.xs})`};
